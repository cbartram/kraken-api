...
public class BankItemWidget implements Widget {
    ...
    public String[] getActions() {
        int xQuantity = context.getVarbitValue(VarbitID.BANK_REQUESTEDQUANTITY);
        boolean bankItemOps = context.getVarbitValue(VarbitID.BANK_BANKOPS_TOGGLE_ON) == 1;
        boolean leavePlaceholder = context.getVarbitValue(VarbitID.BANK_LEAVEPLACEHOLDERS) == 0;
        String[] actions = new String[11];
        switch (context.getVarbitValue(VarbitID.BANK_QUANTITY_TYPE)) {
            default:
            case 0:
