...
/**
 * The {@code TableComponent} class represents a customizable table component used for rendering
 * tabular data in a graphical user interface. It provides options to define table properties,
 * layout, column and row configurations, and controls for customization such as alignments,
 * colors, and bounds. This class extends the capabilities of {@code LayoutableRenderableEntity}.
 *
 * <p>The table supports the following features:
 * <ul>
 *   <li>Dynamic addition and configuration of rows and columns.</li>
 *   <li>Per-element, per-row, and per-column customization of alignment and colors.</li>
 *   <li>Automatic adjustment of column widths based on content.</li>
 *   <li>Rendering in a graphical context with appropriate spacing and alignment.</li>
 *   <li>Helper utilities for string manipulation, text alignment, and graphical calculations.</li>
 * </ul>
 *
 * <p>The class is designed to be highly configurable and ensures that content is visually
 * aligned and spaced across the table's structure.
 * Note: This code was taken from the following source here:
 * - https://github.com/lucid-plugins/SideloadPlugins/blob/master/src/main/java/com/lucidplugins/lucidgauntlet/table/TableComponent.java
 * - https://github.com/OreoCupcakes/kotori-plugins/blob/master/kotoriutils/src/main/java/com/theplug/kotori/kotoriutils/rlapi/table/TableComponent.java
 * All credit to the authors of this code goes to them. The projects are both open source, and the Kraken API provides these components
 * as a utility to be used within other plugins. Kraken API in no way claims to have written or owns this code.
 */
@Setter
public class TableComponent implements LayoutableRenderableEntity {
     ...
     * @param columnRow The column row to get the width array for
